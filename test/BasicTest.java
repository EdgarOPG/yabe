...
public class BasicTest extends UnitTest {
    ...
    public void useTheCommentsRelation() {
        ...
        //  Check that all comments have benn deleted
        assertEquals(1, User.count());
    ...
    public void testTags() {
        ...
        //  Create a new post
        Post bobPost = new Post(bob, "My first post", "Hello word").save();
        Post anotherBobPost = new Post(bob, "Hop", "Hello word").save();
...
//        assertEquals(1, Post.findTaggedWith("Green").size());
        ...
        assertEquals(
                "[{pound=2, tag=Red}, {pound=1, tag=Blue}, {pound=1, tag=Green}]", cloud.toString()
        );
    }
